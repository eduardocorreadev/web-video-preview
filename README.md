...
<p>Nesse projeto iremos utilizar vídeos do Youtube, e sorte a nossa que o Youtube tem seu próprio gerador de iframe com já tudo configurado e para utilizar, veja o gif a baixo: </p>
...
- ``rel=0`` - Desativar a exibição de vídeos relacionados quando a reprodução do vídeo inicial acaba;
...
<p>É importante criar uma váriavel para salvar o estado inicial da url do iframe.</p>

```JS
let saveValueIframe = iframeElement.src
```

<p>Nesse Preview o vídeo será reproduzido por 30 segundos, então vamos criar uma váriavel para "setTimeout()".</p>
...
<p>Então, quando o usuário entrar com o mouse na box do vídeo, será verificado se não existe nada no index "5" da url, se não existir nada será adiconado o parâmetro: "&autoplay=1"...</p>
...
```
<p>Depois de adicionado e já podendo iniciar o vídeo com o passar do mouse, precisamos dizer que enquanto o mouse estiver dentro da box do vídeo o vídeo rode por 30s. Para isso iremos pegar aquela váriavel criada lá no início. Lembra dela? Certo! Ela será utilizada para adicionar um "setTimeout()" de 30s... </p>
...
<p>Quando acabar os longos 30s, vamos remover o "&autoplay=1" da url pra parar o vídeo. Pra mim, a forma mais fácil de fazer isso é reescrevendo o src com aquela váriavel criada para salvar o estado inicial do "iframeElement.src". Então passa isso...</p>
